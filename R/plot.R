...
standard_normal_plot<-function(size=5) {
  ...
  normal_plot<-ggplot(snd,aes(x=x,y=y))+
    geom_line(linewidth=2,alpha=1,color=linecolor)+
  ...
  normal_plot<-normal_plot+
    ...
    annotate("segment",x=z_score,xend=z_score,y=rep(line_1+.02,length(z_score)),yend=rep(line_1+.01,length(z_score)),alpha=.5)+
    geom_hline(yintercept=line_1+.02,alpha=.5,size=.1,color=linecolor)+
    ...
    geom_hline(yintercept=line_2+.02,alpha=.5,size=.1,color=linecolor)+
    ...
    geom_hline(yintercept=line_3+.02,alpha=.5,size=.1,color=linecolor)+
    ...
    geom_hline(yintercept=line_4+.02,alpha=.5,size=.1,color=linecolor)+
    ...
    geom_hline(yintercept=line_5+.02,alpha=.5,size=.1,color=linecolor)+
    ...
    geom_hline(yintercept=line_6+.02,alpha=.5,size=.1,color=linecolor)+
    ...
    geom_hline(yintercept=line_7+.02,alpha=.5,size=.1,color=linecolor)+
